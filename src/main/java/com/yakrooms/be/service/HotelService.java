...
public interface HotelService {
    ...
    Page<HotelWithLowestPriceProjection> getAllHotels(Pageable pageable);
...
//    Page<HotelResponse> searchHotels(String district, String hotelType, int page, int size);
    ...
    Page<com.yakrooms.be.projection.HotelWithLowestPriceProjection> getAllHotelsSortedByHighestPrice(Pageable pageable);
